...
interface PortfolioNewsTableProps {
...
export function PortfolioNewsTable({ articles, loading }: PortfolioNewsTableProps) {
  if (loading) {
    return (
  ...
  if (articles.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-black/50 dark:text-white/50">News for your portfolio holdings will appear here.</p>
      </div>
    );
  }
