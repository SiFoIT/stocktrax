              ...
              >
                <td className="px-4 py-4">
                  ...
                  >
                    ...
                    <span className="font-semibold text-blue-400 group-hover:text-blue-300 underline decoration-blue-400/40 group-hover:decoration-blue-300 underline-offset-2 transition-colors">{holding.symbol}</span>
                  </button>
                </td>
