                ...
                <td className="pl-2 pr-1 py-4 text-right">
                  <div className="flex items-center justify-end gap-1">
                    {onOpenAlerts && (
                      ...
                      >
                        <svg className={`${alertStates?.[item.id]?.triggered ? "w-5 h-5 animate-[bell-ring_2s_ease-in-out_infinite] origin-top" : "w-4 h-4"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
