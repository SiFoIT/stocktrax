                ...
                <td className="pl-2 pr-1 py-4 text-right">
                  <div className="flex items-center justify-end gap-1">
                    {onOpenAlerts && (
                      ...
                      >
                        <svg className={`w-4 h-4 ${alertStates?.[item.id]?.triggered ? "animate-[bell-ring_2s_ease-in-out_infinite] origin-top" : ""}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
